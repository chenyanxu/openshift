...
run_cmd run "oc process -f ${CONFDIR}/${METRICS} -v MASTER_URL=https://kubernetes.default.svc.cluster.local:443,HAWKULAR_METRICS_HOSTNAME=${OSE_MASTER},USE_PERSISTENT_STORAGE=false | oc create -f -"
